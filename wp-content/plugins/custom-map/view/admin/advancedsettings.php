...
jQuery(document).ready(function(){
  //initMap();
    jQuery("#custom_map_shortcode").val(<?php echo $_REQUEST['map_id'];?>);
});
</script>
<?php endif;?>
...
<?php if(isset($_REQUEST['map_id'])):?>
<a style="margin-top: 10px;color: #222;text-decoration: none;" href ="admin.php?page=custom_maps_polygons&map_id=<?php echo $_REQUEST['map_id'];?>"><?php _e('Polygons', 'custom_maps');?></a>
<?php else:?>
